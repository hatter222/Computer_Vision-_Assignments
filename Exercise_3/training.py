...
#   3) Extract face embedding and update face identification (mode "indent") or clu stering (mode "cluster").
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', type=str,
                        default="E:/V/FAU-MIDP/4 SEM/ComputerVision Project/computer_vision_2020/Exercise_3/datasets/training_data/Nancy_Sinatra/%4d.jpg")
