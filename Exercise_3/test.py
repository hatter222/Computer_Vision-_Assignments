...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', type=str, default="E:/V/FAU-MIDP/4 SEM/ComputerVision Project/computer_vision_2020/Exercise_3/datasets/test_data/Nancy_Sinatra/%04d.jpg")
