...
obj1 = ReadableDicomDataset("level-0-frames-0-19278.dcm")
...
tissue_image3 = obj1.read_region((0,0),3,(400,300),1)
...
k=0
h=0
while (i <10 and j<10 and k<10 and h<10):
...
#      loc_3=((random.randint(0, size[0][0]/ds3)),(random.randint(0, size[0][1]/ds3)))
       ...
       if (canbeused0):
           ...
           x=int(x_ds0*ds0)
           y=int(y_ds0*ds0)
           image_0 = obj1.read_region((x,y),0,(400,300),1)
           img_list2.append(image_0)
...
concentrations= np.array(np.linalg.lstsq(OD.T,D.T ,rcond=-1))[0]                                           #spams.lasso(OD.T, D=D.T, mode=2, lambda1=0.01, pos=True).toarray().T
